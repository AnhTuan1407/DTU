...
public class PersonalController {
    ...
    public ResponseEntity<MapAndTotalPageResponse> getAllListPersonal(@RequestParam(defaultValue = "") String find, @RequestParam(defaultValue = "0") int page,
        ...
        for (IPersonalDTO person : personals) {
            ...
            employeeDTO.setIdEmployee(person.getEMPLOYMENT_ID());
            employeeDTO.setEmployeeNumber(person.getEMPLOYMENT_ID());
            employeeDTO.setEMPLOYMENT_ID(person.getEMPLOYMENT_ID());
            employeeDTOMap.put(person.getEMPLOYMENT_ID(), employeeDTO);
        }
